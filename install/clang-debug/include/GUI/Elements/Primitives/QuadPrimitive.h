...
namespace GUI
{
    ...
    public:
        ...
        glm::ivec2& getPosition() { return m_quad.position; }
        glm::ivec2& getSize() { return m_quad.size; }
        glm::vec2& getUvMin() { return m_quad.uvMin; }
        glm::vec2& getUvMax() { return m_quad.uvMax; }
        TextureId& getTexture() { return m_quad.textureId; }
