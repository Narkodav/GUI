...
namespace GUI {
    ...
    public:
        ...
        void create(const Graphics::InstanceFunctionTable& instanceFunctions, const Graphics::DeviceFunctionTable& functions, 
            ...
            auto shaderStages = cachedShaderStages.subspan(static_cast<size_t>(ShaderCache::ShaderSpecialization::QuadVert), 2);
        ...
        void render(const Graphics::DeviceFunctionTable& functions, Graphics::CommandBuffer cmd) {
